...
OUT_DIR = ROOT / "data" / "results" / "gcx_thickness"
PLOT_DIR = ROOT / "plots" / "gcx_thickness"
...
def main():
    ...
    for ycol in YCOLS:
        ...
        f.savefig(
            PLOT_DIR / f"ppc_{ycol}_treatment.svg",
            bbox_inches="tight",
        )
    ...
    f.savefig(PLOT_DIR / "gcx_thickness_effects.svg", bbox_inches="tight")
