...
RAW_DATA_FILE = ROOT / "data" / "raw" / "rel_gcx_intensity.csv"
PIXEL_FILE = ROOT / "data" / "prepared" / "rel_gcx_intensity_pixels.csv"
CONTOUR_FILE = ROOT / "data" / "prepared" / "rel_gcx_intensity_contours.csv"
STAN_FILE = ROOT / "src" / "glycocalyx" / "model.stan"
IDATA_FILE = ROOT / "data" / "results" / "rel_gcx_intensity" / "idata.nc"
PLOT_DIR = ROOT / "plots" / "rel_gcx_intensity"
