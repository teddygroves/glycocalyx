...
RAW_DATA_FILE = ROOT / "data" / "raw" / "gcx_frap" / "gcx_frap.csv"
PREPARED_DATA_FILE = ROOT / "data" / "prepared" / "gcx_frap.csv"
IDATA_DIR = ROOT / "data" / "results" / "gcx_frap"
PLOT_DIR = ROOT / "plots" / "gcx_frap"
